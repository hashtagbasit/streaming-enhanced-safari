import { i as __toESM, n as __commonJSMin } from "./browser-polyfill.js";
//#endregion
//#region node_modules/webext-bridge/dist/chunk-G7AOUSAZ.js
var import_tiny_uid = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	var generator = (base) => typeof crypto !== "undefined" && typeof crypto.getRandomValues === "function" ? () => {
		const num = crypto.getRandomValues(/* @__PURE__ */ new Uint8Array(1))[0];
...
//#endregion
//#region node_modules/webext-bridge/dist/chunk-REMFLVJH.js
...
var formatEndpoint = ({ context, tabId, frameId }) => {
	if ([
		...
		"popup",
		"options"
	].includes(context)) return context;
...
var destroyCircular = ({ from, seen, to_, forceEnumerable, maxDepth, depth }) => {
	const to = to_ || (Array.isArray(from) ? [] : {});
	seen.push(from);
	if (depth >= maxDepth) return to;
	if (typeof from.toJSON === "function" && from[toJsonWasCalled] !== true) return toJSON(from);
	...
	for (const { property, enumerable } of commonProperties) if (typeof from[property] === "string") Object.defineProperty(to, property, {
		value: from[property],
...
//#endregion
//#region node_modules/webext-bridge/dist/chunk-QIZ4XBKF.js
var createEndpointRuntime = (thisContext, routeMessage, localMessage) => {
	...
	return {
		...
		endTransaction: (transactionID) => {
			openTransactions.get(transactionID)?.reject("Transaction was ended before it could complete");
			openTransactions.delete(transactionID);
		},
...
var createStreamWirings = (endpointRuntime) => {
	...
	async function openStream(channel, destination) {
		...
		const endpoint = typeof destination === "string" ? parseEndpoint(destination) : destination;
		const streamInfo = {
			streamId: (0, import_tiny_uid.default)(),
			channel,
			endpoint
		};
...
//#endregion
//#region node_modules/webext-bridge/node_modules/webextension-polyfill/dist/browser-polyfill.js
var require_browser_polyfill = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
		...
		"use strict";
		if (typeof globalThis.chrome === "undefined" && globalThis.browser) globalThis.chrome = globalThis.browser;
						...
						let sendResponsePromise = new Promise((resolve) => {
							wrappedSendResponse = function(response) {
								if (!loggedSendResponseDeprecationWarning) {
									console.warn(SEND_RESPONSE_DEPRECATION_WARNING, (/* @__PURE__ */ new Error()).stack);
...
//#endregion
export { __spreadValues as a, PortMessage as c, decodeConnectionArgs as d, encodeConnectionArgs as f, __spreadProps as i, createDeliveryLogger as l, createEndpointRuntime as n, formatEndpoint as o, createStreamWirings as r, parseEndpoint as s, require_browser_polyfill as t, createFingerprint as u };
